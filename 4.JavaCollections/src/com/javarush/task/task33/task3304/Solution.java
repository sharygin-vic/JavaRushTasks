...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String nameIn = one.getClass().getSimpleName();
        String nameOut = resultClassObject.getSimpleName();
        jsonData = jsonData.replaceFirst(nameIn.toLowerCase(), nameOut.toLowerCase());
